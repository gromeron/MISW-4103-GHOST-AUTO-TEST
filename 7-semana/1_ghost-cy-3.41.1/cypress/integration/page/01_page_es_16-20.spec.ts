...
describe('Page Escenarios 16 - 20 (ESTRATEGIA DE GENERACIÓN DE DATOS #3)', () => {
    ...
    it("16. Crear pagina con nombre y descripción, verificar que página quedó en estado published; editar página y añadir tags. verificar página en estado published.", () => {
    ...
    it("17. Crear pagina con nombre y descripción, verificar que página quedó en estado published; editar página y añadir page-URL,  verificar que página quedó en estado published.", () => {
    ...
    it("18. Crear pagina con nombre y descripción; sin opcion -feature this page-, verificar que página quedó en estado published; editar página y añadir opción -feature this page-", () => {
        let pageTitle = faker.company.companyName();
        let pageDescripcion = faker.lorem.paragraphs(1);
        page.pagesMain();
        page.pageNew();
    ...
    it("19. Crear pagina con nombre y descripción, verificar que página quedó en estado published; editar página y añadir Excerpt, verificar que página quedó en estado published", () => {
        let pageTitle = faker.company.companyName();
        let pageDescripcion = faker.lorem.paragraphs(1);
    ...
    it("20. Crear página con nombre y descripción, verificar que página quedó en estado published; con fecha actual y después editar misma página con fecha publicación al mes siguiente, verificar que queda en estado scheduled", () => {
        let pageTitle = faker.company.companyName();
        let pageDescripcion = faker.lorem.paragraphs(1);
